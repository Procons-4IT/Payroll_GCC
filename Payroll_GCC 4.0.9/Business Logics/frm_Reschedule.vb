Public Class clsReschedule
    ...
    Private Sub Databind(ByVal oform As SAPbouiCOM.Form, ByVal aCode As String)
        Try
            ...
            oGrid.DataTable.ExecuteQuery("SELECT T0.[Code], T0.[Name], T0.[U_Z_TrnsRefCode], T0.[U_Z_EmpID], T0.[U_Z_LoanCode], T0.[U_Z_LoanName], T0.[U_Z_LoanAmount], T0.[U_Z_DueDate], T0.[U_Z_OB], T0.[U_Z_EMIAmount], T0.[U_Z_Status], T0.[U_Z_CashPaid], T0.[U_Z_CashPaidDate], T0.[U_Z_StopIns],T0.[U_Z_Balance], T0.[U_Z_Month], T0.[U_Z_Year] FROM [@Z_PAY15]  T0 where T0.""U_Z_TrnsRefCode""='" & aCode & "'  order by ""U_Z_DueDate""")
            FormatGrid(oGrid)
